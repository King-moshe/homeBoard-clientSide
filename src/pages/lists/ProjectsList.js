...
export default function ProjectsList() {
  ...
  return (
    <div className='p-[10px] md:m-[10px] md:w-auto'>
      ...
      <TableContainer component={Paper} className="drop-shadow-xl border-2 border-slate-500 mb-2 rounded-b-lg overflow-scroll h-[80vh] md:h-[72vh] 3xl:h-[80vh] overflow-x-hidden">
        <Table>
          <TableHead>
