...
export default function FilesList() {
    ...
    const handleDownload = async (url) => {
        try {
            const transformedUrl = url.replace( 'https://api.cloudinary.com/v1_1/dnwud1i7t/auto/upload');
    ...
    return (
        <div >
            <div className='font-medium text-neutral-300 mb-0.5 border-2 p-3 m-0.5 flex justify-between colors2 rounded-lg'>
                <span className="font-bold text-lg"><o className="font-extralight">מסמכים של:</o> {client.name}</span>
