                    ...
                    <TableBody>
                        {paginatedData.map((row, i) => (
                            <TableRow key={row._id} className="">
                                ...
                                <TableCell align='right' className="border border-slate-300"> <AccountCircleIcon /> {row.user_name} </TableCell>
                                <TableCell align='center' className="border border-slate-300" style={{ backgroundColor: row.execution_status === 'waiting' ? 'gold' : 'green'}}>
                                    {row.execution_status === 'done' ? 'בוצע' : 'ממתין לטיפול'}
                                </TableCell>
                                <TableCell align='center' className="border border-slate-300 " style={{ backgroundColor: row.importance === 'regular' ? 'orange' : 'red'}}>
                                ...
                                <TableCell align="right" className="border border-slate-300 ">{row.date_created.substring(0, 10)}</TableCell>
