                ...
                <form className="w-full " onSubmit={handleSubmit(onSubForm)}>
                    <div className="md:flex block">
                        <div className="md:w-1/2 md:pe-4 md:p-1">
                            ...
                            <input {...register("title", { required: true, minLength: 2 })} type="text" placeholder="הזן את נושא המשימה" className="w-full p-2 mt-2 border-solid border-2 rounded-lg" />
                        </div>
                        <div className="md:w-1/2 md:pe-4 md:p-1">
                            <label className="text-white">שיוך דייר</label>
                            <select {...register("user_name", { required: true, minLength: 2 })} className="w-full p-2 mt-2 border-solid border-2 rounded-lg">
                    ...
                    <div className="block md:flex">
                        ...
                        <div className="md:w-1/3 md:pe-3 md:p-1 mt-3">
                            ...
                            <select {...register("importance", { required: true, minLength: 2 })} className="w-full p-2 mt-2 border-solid border-2 rounded-lg">
                                <option hidden>בחר</option>
