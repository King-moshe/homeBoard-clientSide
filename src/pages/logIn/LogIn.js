...
import logo2 from '../home/images/logo.png'
...
function Login() {
    ...
    return (
        <div className="overflow-scroll h-screen bg-zinc-800 justify-start" style={{ backgroundImage: `url(${logo2})`, backgroundRepeat: 'no-repeat', backgroundSize: '60px', backgroundPositionX: '10px', backgroundPositionY: '10px' }} >
