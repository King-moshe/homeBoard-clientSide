...
export default function Footer() {
    return (
        <div className=' bg-slate-800  mx-auto text-center'>

            <h1 className='md:text-4xl sm:text-3xl text-xl  py-6 text-slate-300 ' > בקרו באתר</h1>
            <p className='text-[#00bf9a] mx-auto px-2'>בואו לבקר אותנו ברשתות החברתיות, אנו פעילים בפלטפורמות השונות ומפרסמים רבים מהפרויקטים שלנו, בהם תוכלו להתרשם ואולי להזמין עיצוב לדירה שלכם עוד היום<br />אנו מקווים שהתרשמתם וספרו לחברים שלכם<br />נהיה בקשר </p>
            ...
            <div className='flex px-6 md:w-[500px] my-4 mx-auto'>
                ...
                <FaGithubSquare className='mx-auto  cursor-pointer text-black ' size={30} />
                ...
                <RiLinkedinBoxFill className='mx-auto  cursor-pointer text-white ' size={30} />
            ...
            <div className=' text-[#00bf9a]'>נבנה ועוצב ע"י <strong className=' text-slate-300'>M&Y</strong> </div>
            <p className=' text-[#00bf9a]'>כל הזכויות שמורות</p>
