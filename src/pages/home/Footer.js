...
export default function Footer() {
  return (
    <div className='bg-black mx-auto text-center'>
      ...
      <p className='text-white mx-auto px-2'>
        בואו לבקר אותנו ברשתות החברתיות, אנו פעילים בפלטפורמות השונות ומפרסמים רבים מהפרויקטים שלנו, בהם תוכלו להתרשם ואולי
        להזמין עיצוב לדירה שלכם עוד היום
        <br />
        אנו מקווים שהתרשמתם וספרו לחברים שלכם
        <br />
        נהיה בקשר
      </p>
      <div className='flex px-6 md:w-[500px] my-4 mx-auto'>
        <FaFacebookSquare className='mx-auto cursor-pointer text-blue-700' size={30} />
        <a className='mx-auto cursor-pointer insta w-7 h-7 rounded-md' href='https://www.instagram.com/moshe_amar9/' target='_blank' rel='noopener noreferrer'>
        <FaInstagramSquare  size={30} />
        </a>
        <a className='mx-auto cursor-pointer text-white' href='https://github.com/King-moshe?tab=repositories' target='_blank' rel='noopener noreferrer'>
        ...
        <a href='https://www.linkedin.com/in/moshe-amar/' target='_blank' rel='noopener noreferrer'>
      ...
      <div className='p-2'>
        <AiOutlineCopyrightCircle className='mx-auto text-slate-300'/>
      </div>
    </div>
  );
}
